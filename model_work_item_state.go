...
const (
	FINISHEDWorkItemState = "FINISHED"
	REJECTEDWorkItemState = "REJECTED"
	RETURNEDWorkItemState = "RETURNED"
	EXPIREDWorkItemState = "EXPIRED"
	PENDINGWorkItemState = "PENDING"
	CANCELEDWorkItemState = "CANCELED"
)
