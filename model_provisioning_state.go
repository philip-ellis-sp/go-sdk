...
const (
	PENDINGProvisioningState = "PENDING"
	FINISHEDProvisioningState = "FINISHED"
	UNVERIFIABLEProvisioningState = "UNVERIFIABLE"
	COMMITEDProvisioningState = "COMMITED"
	FAILEDProvisioningState = "FAILED"
	RETRYProvisioningState = "RETRY"
)
