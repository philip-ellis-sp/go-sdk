...
**Cluster** | Pointer to [**BaseReferenceDto**](BaseReferenceDto.md) |  | [optional] 
**AccountCorrelationConfig** | Pointer to [**BaseReferenceDto**](BaseReferenceDto.md) |  | [optional] 
**AccountCorrelationRule** | Pointer to [**BaseReferenceDto**](BaseReferenceDto.md) |  | [optional] 
**ManagerCorrelationMapping** | Pointer to [**ManagerCorrelationMapping**](ManagerCorrelationMapping.md) |  | [optional] 
**ManagerCorrelationRule** | Pointer to [**BaseReferenceDto**](BaseReferenceDto.md) |  | [optional] 
**BeforeProvisioningRule** | Pointer to [**BaseReferenceDto**](BaseReferenceDto.md) |  | [optional] 
**Schemas** | Pointer to [**[]BaseReferenceDto**](BaseReferenceDto.md) | List of references to Schema objects | [optional] 
**PasswordPolicies** | Pointer to [**[]BaseReferenceDto**](BaseReferenceDto.md) | List of references to the associated PasswordPolicy objects. | [optional] 
...
**ManagementWorkgroup** | Pointer to [**BaseReferenceDto**](BaseReferenceDto.md) |  | [optional] 
