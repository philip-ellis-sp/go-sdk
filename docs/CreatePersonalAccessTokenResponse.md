...
`func NewCreatePersonalAccessTokenResponse(id string, secret string, name string, owner BaseReferenceDto, created time.Time, ) *CreatePersonalAccessTokenResponse`
