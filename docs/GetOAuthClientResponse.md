...
**AccessTokenValiditySeconds** | **string** | The number of seconds an access token generated for this API Client is valid for | 
**RefreshTokenValiditySeconds** | **string** | The number of seconds a refresh token generated for this API Client is valid for | 
...
`func NewGetOAuthClientResponse(id string, businessName string, homepageUrl string, name string, description string, accessTokenValiditySeconds string, refreshTokenValiditySeconds string, redirectUris []string, grantTypes []GrantType, accessType AccessType, type_ ClientType, internal bool, enabled bool, strongAuthSupported bool, claimsSupported bool, created time.Time, modified time.Time, ) *GetOAuthClientResponse`
...
`func (o *GetOAuthClientResponse) GetAccessTokenValiditySeconds() string`

GetAccessTokenValiditySeconds returns the AccessTokenValiditySeconds field if non-nil, zero value otherwise.

### GetAccessTokenValiditySecondsOk

`func (o *GetOAuthClientResponse) GetAccessTokenValiditySecondsOk() (*string, bool)`
...
`func (o *GetOAuthClientResponse) SetAccessTokenValiditySeconds(v string)`
...
`func (o *GetOAuthClientResponse) GetRefreshTokenValiditySeconds() string`
...
`func (o *GetOAuthClientResponse) GetRefreshTokenValiditySecondsOk() (*string, bool)`
...
`func (o *GetOAuthClientResponse) SetRefreshTokenValiditySeconds(v string)`
