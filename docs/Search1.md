...
**QueryType** | Pointer to [**QueryType**](QueryType.md) |  | [optional] [default to SAILPOINT]
**QueryVersion** | Pointer to **NullableString** |  | [optional] 
...
**AggregationType** | Pointer to [**AggregationType**](AggregationType.md) |  | [optional] [default to DSL]
**AggregationsVersion** | Pointer to **NullableString** |  | [optional] 
