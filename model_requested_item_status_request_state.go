...
const (
	EXECUTINGRequestedItemStatusRequestState = "EXECUTING"
	REQUEST_COMPLETEDRequestedItemStatusRequestState = "REQUEST_COMPLETED"
	CANCELLEDRequestedItemStatusRequestState = "CANCELLED"
	TERMINATEDRequestedItemStatusRequestState = "TERMINATED"
	PROVISIONING_VERIFICATION_PENDINGRequestedItemStatusRequestState = "PROVISIONING_VERIFICATION_PENDING"
	REJECTEDRequestedItemStatusRequestState = "REJECTED"
	PROVISIONING_FAILEDRequestedItemStatusRequestState = "PROVISIONING_FAILED"
	NOT_ALL_ITEMS_PROVISIONEDRequestedItemStatusRequestState = "NOT_ALL_ITEMS_PROVISIONED"
	ERRORRequestedItemStatusRequestState = "ERROR"
)
