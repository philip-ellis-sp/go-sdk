...
func (r ApiDeleteSourceRequest) Execute() (*BaseReferenceDto, *http.Response, error) {
...
func (a *SourcesApiService) DeleteSourceExecute(r ApiDeleteSourceRequest) (*BaseReferenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
