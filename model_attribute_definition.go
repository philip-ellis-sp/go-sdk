...
type AttributeDefinition struct {
	...
	Schema *BaseReferenceDto `json:"schema,omitempty"`
...
// SetSchema gets a reference to the given BaseReferenceDto and assigns it to the Schema field.
...
func (o AttributeDefinition) MarshalJSON() ([]byte, error) {
	...
	if o.IsMultiValued != nil {
		toSerialize["isMultiValued"] = o.IsMultiValued
	}
	if o.IsEntitlement != nil {
